...
{
    $_SESSION['error'] = "wybierz kategorie";
...
{
    $_SESSION['error'] = "podaj link do gmap";
    header("Location: atractionAdd.php");
    exit();
}
if(!isset($sci))    
...
$sql = "INSERT INTO atrakcje Values(NULL,'$kat','$tytul','$opis','$sci','$link')";
